...
<body>
    <div align="center">
        <a href="https://davidmuns.netlify.app/" target="_blank"><img src="https://github.com/davidmuns/assets/blob/main/porfolio.JPG" alt="header" title="portfolio-davidmuns"></a>
    </div>
<!-- ############################## -->
<!-- ABOUT -->
<!-- ############################## -->
    <h1>About</h1>
        <p>
           Passionate about programming and with experience in the industrial sector, I have developed skills in programming systems based on PLC, HMI, SCADA and Industrial Robotics as well as knowledge in frontend and backend technologies such as Java, Spring Boot, Typescript and Angular. My short but intense career in software development as well as my passion for technology have allowed me to work on Open Source projects and to design and create my own. Currently, I am looking for opportunities to apply my skills and knowledge to challenging projects as a developer. If you are interested in my profile please, feel free to contact me.
        </p>
...
<!-- ############################## -->
    ...
    <div align="left">
        <div>
          ...
          <a href="https://drive.google.com/file/d/17aqlKMcy71hkbQNPEQUK9U1qc0-lcMt3/view?usp=share_link">&nbsp;Download cv</a>    
         </div>
     </div>
<!-- ############################## -->
<!-- EDUCATION -->
