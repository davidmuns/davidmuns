...
<body>
    <div align="center">
        <a href="https://davidmuns.netlify.app/" target="_blank"><img src="https://github.com/davidmuns/assets/blob/main/portfolio2.JPG" alt="header" title="portfolio-davidmuns"></a>
    </div>
<!-- ############################## -->
<!-- ABOUT -->
<!-- ############################## -->
    <h1>About</h1>
        <p>
      Passionate about programming with experience in the IT and industrial sector, I have developed skills in web application development frontend and backend with Java, Spring Boot, typescript and Angular as well as in programming systems based on PLC (Programmable Logic Controller), HMI (Human Machine Interface), SCADA (Supervisory Control and Data Acquisition) and Industrial Robotics. If you are interested in my profile please, feel free to contact me.
        </p>
...
<!-- ############################## -->
    ...
    <div align="left">
        <div>
          ...
          <a href="https://drive.google.com/file/d/1qJLjwIU9ZtbWTlKPq7iz_NViXAZM7tfb/view?usp=sharing">&nbsp;Download cv</a>    
         </div>
     </div>
<!-- ############################## -->
<!-- EDUCATION -->
